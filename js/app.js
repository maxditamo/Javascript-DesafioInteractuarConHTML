...
function mostrarCarrito(productoAgregar) {
    ...
    div.innerHTML= `<p style="margin-bottom: 0%;"><font style="vertical-align: inherit;">${productoAgregar.nombre}</font></p>
                    <p style="margin-bottom: 0%;"><font class="precioProducto" style="vertical-align: inherit;">$${productoAgregar.precio}</font></p>
                    <button id="eliminar${productoAgregar.id}" class="boton-eliminar" type="button" class="btn btn-outline-danger ms-4 d-flex align-items-center">
...
//Boton eliminar productos en carrito
